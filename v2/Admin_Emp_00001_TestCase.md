...
| 6 | `/userSave` | 사용자 등록 (일반) | RequestParam | INSERT | MMEMBSTB<br>MROLEDTB<br>MROLEHTB<br>MUSERSTB<br>USERMLTB  |
| 7 | `/userAdminSave` | Admin 사용자 등록 | RequestParam | INSERT | MUSERSTB  |
| 8 | `/IDDelete` | 사용자 삭제 | RequestParam | DELETE | DELETEMLTB<br>MUSERSTB<br>USERMLTB  |
| 9 | `/userUpdate` | 사원 정보 수정 | RequestParam | UPDATE | MROLEDTB<br>MROLEHTB<br>MUSERSTB<br>USERMLTB  |
| 10 | `/adminUserUpdate` | Admin 사원 수정 (userRole 없음) | RequestParam | UPDATE | MROLEDTB<br>MROLEHTB<br>MUSERSTB<br>USERMLTB  |
| 11 | `/pwReset` | 비밀번호 초기화 | RequestParam | UPDATE | MUSERSTB  |
| 12 | `/moveEmp` | 사원 매장 이동 | RequestParam | UPDATE | GETUSERMLTB<br>MUSERSTB<br>TB_USER_LAST_MENU<br>USERMLTB  |
...
| 16 | `/unlock` | 계정 잠금 해제 | RequestParam | UPDATE | MUSERSTB  |
