...
async def run_test():
    async with async_playwright() as p:
        try:
            ...
            # HQ Screen Test
            print('\n=== Starting HQ Screen (hq_system_00011) Test ===')
            ...
            print('Navigating to hq_system_00011...')
            await page.goto('http://localhost:8080/backoffice/view/main/hq/system/hq_system_00011')
            await page.wait_for_timeout(3000)
            await page.wait_for_selector('#hq_system_00011_t01', timeout=10000)
            
            # Set search dates via JS since they are readonly
            print('Setting search dates to 2026-06-01 to 2026-06-12...')
            await page.evaluate("document.getElementById('searchFromDate').value = '2026-06-01'")
            await page.evaluate("document.getElementById('searchEndDate').value = '2026-06-12'")
            await page.wait_for_timeout(1000)
            
            print('Clicking Search (조회)...')
            await page.locator('#hq_system_00011_search_btn').click()
            await page.wait_for_timeout(3000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/hq_system_00011_search.png')
            
            print('Filtering by Request User ID/Name (shopadmin)...')
            await page.locator('#searchUserId').fill('shopadmin')
            await page.locator('#hq_system_00011_search_btn').click()
            await page.wait_for_timeout(2000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/hq_system_00011_search_id.png')
            ...
            await page.locator('#hq_system_00011_search_btn').click()
            await page.wait_for_timeout(2000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/hq_system_00011_search_ip.png')
            
            print('Testing Reset (초기화) button...')
            await page.locator("a[onclick=\"clearFields('hq_system_00011_form');\"]").click()
            await page.wait_for_timeout(2000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/hq_system_00011_reset.png')
            
            await context1.close()
            print('=== HQ Screen Test Completed ===')
            
            # Admin Screen Test
            print('\n=== Starting Admin Screen (admin_system_00011) Test ===')
            ...
            print('Navigating to admin_system_00011...')
            await page.goto('http://localhost:8080/backoffice/view/main/admin/system/admin_system_00011')
            await page.wait_for_timeout(3000)
            await page.wait_for_selector('#admin_system_00011_t01', timeout=10000)
            ...
            await page.locator('#admin_system_00011_search_btn').click()
            await page.wait_for_timeout(3000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/admin_system_00011_search.png')
            
            print('Filtering by Request User ID/Name (admin2)...')
            await page.locator('#searchUserId').fill('admin2')
            await page.locator('#admin_system_00011_search_btn').click()
            await page.wait_for_timeout(2000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/admin_system_00011_search_id.png')
            ...
            await page.locator('#admin_system_00011_search_btn').click()
            await page.wait_for_timeout(2000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/admin_system_00011_search_ip.png')
            
            print('Testing Reset button...')
            await page.locator("a[onclick=\"clearFields(\'admin_system_00011_form\');\"]").click()
            await page.wait_for_timeout(2000)
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/admin_system_00011_reset.png')
            
            await context2.close()
            print('=== Admin Screen Test Completed ===')
            
            # DB Verification
            print('\n=== Verifying Event Logs in Database (hmsfns.SRVLOGTB) ===')
            ...
            cur = conn.cursor()
            cur.execute("""
                SELECT LOG_SEQ, USER_ID, REMOTE_IP, SERVICE_MENU, SERVICE_NAME, SERVICE_TYPE, CREATE_DTIME 
                FROM hmsfns.SRVLOGTB 
                WHERE USER_ID IN ('admin2', 'shopadmin') 
                ORDER BY CREATE_DTIME DESC, LOG_SEQ DESC 
                LIMIT 5
            """)
            print("Latest 5 logs in SRVLOGTB:")
            ...
            try:
                ...
                # HQ Screen Progress
                data["screens"]["hq_system_00011"] = {
                    "complete": True,
                    "memo": "로그인 ID: shopadmin - 웹 서비스 이벤트 로그 조회 (본사 권한으로 영업정보시스템 이벤트 로그 조회)"
                }
                # Admin Screen Progress
                data["screens"]["admin_system_00011"] = {
                    "complete": True,
                    "memo": "로그인 ID: admin2 - 웹 서비스 이벤트 로그 조회 (관리자 권한으로 영업정보시스템 이벤트 로그 조회)"
                }
            ...
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/system_00011_error.png')
        finally:
            await browser.close()
