    ...
    async with async_playwright() as p:
        try:
            ...
            async def log_response(response):
                if "st_stock_00002" in response.url:
                    try:
            ...
            # Step 2: Navigate to target screen (st_stock_00002)
            print('Navigating to st_stock_00002 (Store Stock Adjustment Status)...')
            await page.goto('http://localhost:8080/backoffice/view/main/st/stock/st_stock_00002')
            ...
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/st_stock_00002_search.png')
            print('Captured search screen.')
            
            # Check if there are row data in the summary table
            no_data = page.locator('#st_stock_00002_t01 tbody tr.no-records-found')
            rows = page.locator('#st_stock_00002_t01 tbody tr')
            ...
            if await no_data.count() == 0 and await rows.count() > 0:
                ...
                await page.screenshot(path='D:/hmTest/backoffice/QaReport/st_stock_00002_detail.png')
