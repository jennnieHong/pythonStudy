...
async def run_test():
    async with async_playwright() as p:
        ...
        try:
            print('Starting Comprehensive Playwright Test for hq_stock_00001 (Current Stock)...')
            
            # Automatically accept dialogs
            page.on("dialog", lambda dialog: asyncio.create_task(dialog.accept()))
            
            # Step 1: Force Logout / Login Check
            ...
            # If already logged in, let's force logout by going to /backoffice/logout or clicking logout button
            ...
            if 'main' not in page.url:
                ...
                await page.screenshot(path='D:/hmTest/backoffice/QaReport/hq_stock_00001_login_fail.png')
                await browser.close()
                return
                
            # Step 2: Navigate to target screen hq_stock_00001
            print('Navigating directly to hq_stock_00001...')
            await page.goto('http://localhost:8080/backoffice/view/main/hq/stock/hq_stock_00001')
            await page.wait_for_timeout(3000)
            # Wait for bootstrap table components to load
            await page.wait_for_selector('#hq_stock_00001_t01', timeout=10000)
            print('[SUCCESS] Navigated to Current Stock screen.')
            ...
            search_btn = page.locator('#hq_stock_00001_search_btn')
            ...
            screenshot_path = 'D:/hmTest/backoffice/QaReport/hq_stock_00001_search.png'
            await page.screenshot(path=screenshot_path)
            print(f'Screenshot saved to {screenshot_path}')
            
            # Step 5: Check Detail Modal (Click first goods item)
            # Find a cell with class 'table-onclick' (Goods Code column)
            first_goods_cell = page.locator('#hq_stock_00001_t01 td.table-onclick').first
            if await first_goods_cell.count() > 0:
                ...
                modal_screenshot_path = 'D:/hmTest/backoffice/QaReport/hq_stock_00001_detail_modal.png'
            ...
            await page.screenshot(path='D:/hmTest/backoffice/QaReport/hq_stock_00001_error.png')
        finally:
            await browser.close()
