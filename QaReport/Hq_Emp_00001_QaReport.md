# QA Report: Hq_Emp_00001 본사 사원 관리
**작성일**: 2026-06-22  
**작성자**: AI QA Agent (Antigravity)  
**대상 화면**: [HQ] 인사관리 > 사원관리 (hq_emp_00001)  
...
| 구분 | 파일 경로 |
|------|-----------|
| Controller | `hyundai-backoffice-webapp/.../controller/hq/employee/Hq_Emp_00001_Controller.java` |
| Service | `hyundai-backoffice-layer-service/.../service/hq/employee/Hq_Emp_00001_Service.java` |
| Mapper (Interface) | `hyundai-backoffice-layer-persistence/.../dao/hq/employee/Hq_Emp_00001_Mapper.java` |
| SQL XML | `hyundai-backoffice-webapp/.../sqlmapper/employee/Hq_Emp_00001_Sql.xml` |
...
### 2.1 Base URL
```
POST /backoffice/data/hq/employee/hq_emp_00001/{endpoint}
```
...
- `getEmpiId` 호출을 통해 사원코드(`EMP_ID`) 채번.
...
- `Hq_Emp_00001_Sql.xml` 내의 `selectHqEmpList`, `selectStoreEmpList`, `selectHqEmpDtList` 쿼리에 Oracle 레거시 문법인 외부조인 `(+)`가 존재합니다:
  ```sql
...
- 본사 사원관리 화면 최초 진입: ![hq_emp_00001_initial](/C:/Users/uoshj/.gemini/antigravity-ide/brain/1a4236fc-92c9-48e6-b3ea-a3f6617131ea/hq_emp_00001_initial.png)
- 신규 본사사원(`playhq001`) 등록 완료: ![hq_emp_00001_saved](/C:/Users/uoshj/.gemini/antigravity-ide/brain/1a4236fc-92c9-48e6-b3ea-a3f6617131ea/hq_emp_00001_saved.png)
- 본사사원 정보 수정 완료: ![hq_emp_00001_updated](/C:/Users/uoshj/.gemini/antigravity-ide/brain/1a4236fc-92c9-48e6-b3ea-a3f6617131ea/hq_emp_00001_updated.png)
- 본사사원 삭제 완료: ![hq_emp_00001_deleted](/C:/Users/uoshj/.gemini/antigravity-ide/brain/1a4236fc-92c9-48e6-b3ea-a3f6617131ea/hq_emp_00001_deleted.png)
