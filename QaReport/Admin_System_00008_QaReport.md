...
| 구분 | 파일 경로 |
|------|-----------|
| Controller | `hyundai-backoffice-webapp/.../controller/admin/system/Admin_System_00008_Controller.java` |
| Service | `hyundai-backoffice-layer-service/.../service/admin/system/Admin_System_00008_Service.java` |
| Mapper (Interface) | `hyundai-backoffice-layer-persistence/.../dao/admin/system/Admin_System_00008_Mapper.java` |
| SQL XML | `hyundai-backoffice-webapp/.../resources/sqlmapper/system/Admin_System_00008_Sql.xml` |
...
### 2.1 Base URL
```
POST /backoffice/data/admin/system/admin_system_00008
```
...
- `Admin_System_00008_Sql.xml` 내 모든 INSERT/UPDATE 쿼리는 PostgreSQL에 호환되는 표준 SQL 및 `TO_CHAR(SYSDATE, 'YYYYMMDDHH24MISS')`로 마이그레이션이 잘 이루어져 에러 없이 수행되었습니다.
...
2. **분류 및 상세 코드 비고란 입력 길이 제한 누락 (조치 완료)**  
   ...
   - JSP 파일(`admin_system_00008_M01.jsp`, `admin_system_00008_M02.jsp`)의 비고 input 태그에 `maxlength="4000"` 속성을 부여하여 초과 입력되지 않도록 조치하였습니다.
...
- **조회 결과**: ![조회 결과](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_search.png)
- **분류코드 등록 팝업**: ![등록 팝업](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_class_add_modal.png)
- **분류코드 추가 완료**: ![추가 완료](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_added.png)
- **상세코드 등록 팝업**: ![상세코드 팝업](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_detail_add_modal.png)
- **상세코드 추가 완료**: ![상세코드 완료](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_detail_added.png)
- **상세코드 수정 팝업**: ![상세코드 수정](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_detail_modify_modal.png)
- **상세코드 수정 완료**: ![상세코드 수정완료](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_detail_modified.png)
- **분류코드 수정 팝업**: ![분류코드 수정](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_class_modify_modal.png)
- **분류코드 수정 완료**: ![분류코드 수정완료](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_class_modified.png)
- **상세코드 삭제 완료**: ![상세코드 삭제](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_detail_deleted.png)
- **분류코드 삭제 완료**: ![분류코드 삭제](file:///D:/hmTest/backoffice/QaReport/admin_system_00008_class_deleted.png)
