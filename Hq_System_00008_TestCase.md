# Hq_System_00008 — 명칭코드관리 (HQ) 단위 테스트케이스

> **대상 화면**: 시스템관리 > 영업정보시스템 > 명칭코드관리 (`hq_system_00008`)  
> **API Base URL**: `POST /backoffice/data/hq/system/hq_system_00008`  
...
sequenceDiagram
    ...
    participant Ctrl as Hq_System_00008_Controller
    participant Svc as Hq_System_00008_Service
