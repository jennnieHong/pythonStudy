...
def update_memos():
    ...
    mmssrctb["related_tables"] = [
        {
            "table_name": "mgoodstb",
            "description": "[매장별 상품 마스터] MMSSRCTB는 매장별 상품의 레시피 소스 구성 정보를 연결하고 관리하기 위해 MGOODSTB.GOODS_CD 등과 연계되며, 상품별 원가 계산 시 참조됩니다."
        },
        {
            "table_name": "mmembstb",
        ...
        {
            "table_name": "mmslogtb",
            "description": "[웹 변경 이력 로그] 매장별 레시피 소스의 추가, 단가 변경, 폐기 등의 CUD 행위 발생 시 MMSLOGTB 테이블에 감사 이력 로그를 적재하여 감사 추적 경로를 제공합니다."
        }
    ]
    ...
    try:
        ...
        print("Successfully updated table_memos.json with mmssrctb related_tables details!")
